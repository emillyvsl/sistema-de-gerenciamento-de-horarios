...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(choices=[('primeiro_semestre', '1º semestre letivo'), ('segundo_semestre', '2º semestre letivo')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
        ...
        migrations.AddField(
            model_name='periodo',
            name='semestre',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='periodos', to='sgh_app.semestre'),
        ),
        migrations.AddField(
            model_name='anosemestre',
            name='semestre',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ano_semestres', to='sgh_app.semestre'),
        ),
